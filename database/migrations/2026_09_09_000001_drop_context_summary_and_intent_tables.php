        ...
        if (Schema::hasTable('jobs')) {
            DB::table('jobs')
                ->where(function ($query): void {
                    $query->where('payload', 'like', '%SummarizeSceneWindowJob%')
                        ->orWhere('payload', 'like', '%FinalizeSceneContextJob%')
                        ->orWhere('payload', 'like', '%IndexRagSummaryJob%')
                        ->orWhere('payload', 'like', '%RefreshStorytellerIntentJob%');
                })
                ->delete();
        }
    }
