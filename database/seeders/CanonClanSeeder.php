...
class CanonClanSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            $this->row('gangrel', 'Гангрелы', 'Дикари', 'Кочевые одиночки, близкие к дикой природе.'),
            $this->row('giovanni', 'Джованни', 'Некроманты', 'Некромантическая некропольная династия из Венеции.'),
            $this->row('lasombra', 'Ласомбра', 'Сторожа', 'Клан теней и власти, столпы Шабаша.'),
