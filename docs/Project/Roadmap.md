...
- Зафиксировано: `qwen3:8b` поддерживает 40960 токенов, runtime `num_ctx=16384`, максимальный вход Context Assembler — 12000, `num_predict=3000`; оставшиеся 1384 токена — технический запас.
